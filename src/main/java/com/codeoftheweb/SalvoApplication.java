...
public class SalvoApplication {
    ...
    public CommandLineRunner initData(PlayerRepository playerRepository, GameRepository gameRepository,
        ...
        return (args) -> {
            ...
            GamePlayer gp3 = new GamePlayer(date.from(date.toInstant().plusSeconds(3600)), p1, g2);
            GamePlayer gp4 = new GamePlayer(date.from(date.toInstant().plusSeconds(3600)), p2, g2);
            GamePlayer gp5 = new GamePlayer(date.from(date.toInstant().plusSeconds(7200)), p2, g3);
            GamePlayer gp6 = new GamePlayer(date.from(date.toInstant().plusSeconds(7200)), p4, g3);
            GamePlayer gp7 = new GamePlayer(date.from(date.toInstant().plusSeconds(10800)), p2, g4);
            GamePlayer gp8 = new GamePlayer(date.from(date.toInstant().plusSeconds(10800)), p1, g4);
            GamePlayer gp9 = new GamePlayer(date.from(date.toInstant().plusSeconds(14400)), p4, g5);
            GamePlayer gp10 = new GamePlayer(date.from(date.toInstant().plusSeconds(14400)), p1, g5);
            GamePlayer gp11 = new GamePlayer(date.from(date.toInstant().plusSeconds(18000)), p3, g6);
            GamePlayer gp12 = new GamePlayer(date.from(date.toInstant().plusSeconds(21600)), p4, g7);
            GamePlayer gp13 = new GamePlayer(date.from(date.toInstant().plusSeconds(25200)), p1, g8);
            GamePlayer gp14 = new GamePlayer(date.from(date.toInstant().plusSeconds(25200)), p4, g8);
            gamePlayerRepository.saveAll(Arrays.asList(gp1, gp2, gp3, gp4, gp5, gp6, gp7, gp8, gp9,
            ...
            Score sc3 = new Score(g2, p1, 0.5, Date.from(date.toInstant().plusSeconds(3600)));
            Score sc4 = new Score(g2, p2, 0.5, Date.from(date.toInstant().plusSeconds(3600)));
            Score sc5 = new Score(g3, p2, 1, Date.from(date.toInstant().plusSeconds(7200)));
            Score sc6 = new Score(g3, p4, 0, Date.from(date.toInstant().plusSeconds(7200)));
            Score sc7 = new Score(g4, p2, 0.5, Date.from(date.toInstant().plusSeconds(10800)));
            Score sc8 = new Score(g4, p1, 0.5, Date.from(date.toInstant().plusSeconds(10800)));
